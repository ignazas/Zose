...
HD_PWD='E:/Development/zose/zose.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zose_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zose_wrapper.tcl
