...
HD_PWD='E:/Development/zose/zose.runs/zose_square_sampler_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zose_square_sampler_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zose_square_sampler_0_0.tcl
