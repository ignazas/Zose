...
HD_PWD='E:/Development/zose/zose.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zose_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zose_wrapper.tcl -notrace
