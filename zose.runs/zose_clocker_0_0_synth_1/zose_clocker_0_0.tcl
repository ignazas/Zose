...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix zose_clocker_0_0_ zose_clocker_0_0.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ zose_clocker_0_0_stub.v
 lappend ipCachedFiles zose_clocker_0_0_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ zose_clocker_0_0_stub.vhdl
 lappend ipCachedFiles zose_clocker_0_0_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ zose_clocker_0_0_sim_netlist.v
 lappend ipCachedFiles zose_clocker_0_0_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ zose_clocker_0_0_sim_netlist.vhdl
 lappend ipCachedFiles zose_clocker_0_0_sim_netlist.vhdl

 config_ip_cache -add -dcp zose_clocker_0_0.dcp -move_files $ipCachedFiles -use_project_ipc -ip [get_ips zose_clocker_0_0]
}

rename_ref -prefix_all zose_clocker_0_0_

# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef zose_clocker_0_0.dcp
