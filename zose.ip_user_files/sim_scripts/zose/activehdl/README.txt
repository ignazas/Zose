...
#
# Generated by export_simulation on Thu Apr 19 20:12:37 +0300 2018
#
################################################################################
...
'-reset_run' switch to the './zose.sh' script.
...
./zose.sh -noclean_files

For more information on the script, please type './zose.sh -help'.
